<template>
  <footer
    class="text-center py-5 border-t border-stone-300 border-dashed bg-stone-100 relative"
  >
    <i
      class="icon-scissors absolute left-1/2 top-0 -translate-y-1/2 rotate-90"
    />
